...
export default function Register() {
  ...
  return (
    <div className="min-h-[80vh] flex flex-col bg-slate-50 py-12 dark:bg-slate-900 text-black dark:text-white">
      <div className="grow flex items-center justify-center p-4">
        <div className="w-full max-w-md ">
          <div className="bg-white p-10 dark:bg-slate-900 text-black dark:text-white rounded-[2.5rem] border border-slate-200 shadow-2xl space-y-8 relative overflow-hidden">
            ...
            <form className="space-y-6 " onSubmit={handleRegister}>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  name="image"
                  startContent={<User className="w-5 h-5 text-slate-400" />}
                  className="border-2 border-slate-200b dark:text-black hover:border-blue-600/50 focus-within:border-blue-600 transition-all duration-300 h-14 bg-white w-full rounded-2xl"
                />
              </div>
            ...
            <div className="space-y-4">
              <Button
                variant="bordered"
                className="w-full h-12 font-bold rounded-2xl border-slate-200 hover:bg-slate-50 hover:dark:bg-black dark:text-white transition-colors gap-3"
